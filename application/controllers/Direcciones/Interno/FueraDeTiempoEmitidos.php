...
class FueraDeTiempoEmitidos extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('area_trabajo')) {
			...
			$data['fueratiempoemitidos'] = $this -> Modelo_direccion -> getAllFueraTiempoEmitidos($this->session->userdata('area_trabajo'));
			...
			$this->load->view('directores/internos/fueradetiemposemitidos');
