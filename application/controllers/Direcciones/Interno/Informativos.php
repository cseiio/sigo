...
class Informativos extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('nombre')) {
			...
			$data['informativos'] = $this -> Modelo_direccion -> getAllInformativosRececepcionados($this->session->userdata('id_direccion'));
			$this->load->view('plantilla/header', $data);
			$this->load->view('directores/internos/informativos');
