	...
	public function ModificarArchivos()
	{
        ...
        //CARGANDO SLIDER
            ...
            // Subimos el segundo Archivo
				...
				$actualizarArchivos = $this->Modelo_direccion->actualizarArchivosdeRespuestaExterno($id_recepcion, $respuesta, $anexos);
				...
				if ($actualizarArchivos) {
					$this->session->set_flashdata('exito', 'Se ha enviado actualizado los archivos de respuesta y anexos correctamente');
						redirect(base_url() . 'Direcciones/Externos/ContestadosFueraTiempoDir/');
				}
				else
				{
