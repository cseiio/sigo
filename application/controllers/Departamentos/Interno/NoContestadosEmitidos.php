...
class NoContestadosEmitidos extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('area_trabajo')) {
			...
			$data['nocontestadosemitidos'] = $this -> Modelo_departamentos -> getAllNoContestadosEmitidos($this->session->userdata('area_trabajo'));
			...
			$this->load->view('deptos/internos/nocontestadosemitidos');
...
/* End of file NoContestadosEmitidos.php */
/* Location: ./application/controllers/NoContestadosEmitidos.php */