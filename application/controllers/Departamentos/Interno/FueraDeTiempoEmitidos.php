...
class FueraDeTiempoEmitidos extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('area_trabajo')) {
			...
			$data['fueradetiempoemitidos'] = $this -> Modelo_departamentos -> getAllFueraTiempoEmitidos($this->session->userdata('area_trabajo'));
			...
			$this->load->view('deptos/internos/fueradetiempoemitidos');
...
/* Location: ./application/controllers/FueraDeTiempoEmitidos.php */