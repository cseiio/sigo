...
public function ModificarArchivos()
	{
        ...
        //CARGANDO SLIDER
            ...
            // Configuración para el Archivo 1
				    ...
				    $config['file_name'] = 'Folio_'.$id_recepcion.'_'.'Oficio_de_respuesta'.'_'.$num_oficio;
            ...
            // Subimos el segundo Archivo
				...
				$actualizarArchivos = $this->Modelo_departamentos->actualizarArchivosdeRespuestaExterno($id_recepcion, $respuesta, $anexos);
				...
				if ($actualizarArchivos) {
					$this->session->set_flashdata('exito', 'Se ha enviado actualizado los archivos de respuesta y anexos correctamente');
						redirect(base_url() . 'Departamentos/Externo/ContestadosFueraTiempoDeptos/');
				}
				else
				{
