...
class NoContestadosEmitidos extends CI_Controller {
	...
	public function index()
	{
		...
		$data['nocontestadosemitidos'] = $this -> Modelo_direccion -> getAllNoContestadosEmitidos('DIRECCIÓN GENERAL');
		$this->load->view('plantilla/header', $data);
		$this->load->view('recepcion/dirgral/internos/nocontestadosemitidos');
