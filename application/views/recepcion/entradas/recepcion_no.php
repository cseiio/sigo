...
?>','<?php echo $row->fecha_termino; ?>','<?php echo $row->prioridad; ?>','<?php echo $is_informativo; ?>','<?php echo $row->codigo_archivistico; ?>', '<?php echo $row->valor_doc; ?>','<?php echo $row->vigencia_doc; ?>','<?php echo $row->tipo_doc_archivistico; ?>','<?php echo $row->clasificacion_info; ?>','<?php echo addcslashes($row->observaciones,"\\\"\"\n\r"); ?>');" class="form-control btn btn-danger btn-sm">
...
function EditarOficio(id,num_oficio, asunto, tipo_recepcion,  tipo_documento, emisor, direccion, fecha_termino, prioridad, is_informativo, codigo, valor_doc, vigencia_doc, tipo_doc_archivistico, clasificacion_info,observaciones)
{
