                    ...
                    <tbody style="font-size:smaller; font-weight: bold ;">
                        <?php foreach ($dependencias as $row) { 
                            ...
                            <tr>
                             ...
                             <td>
                                <a href="<?php echo base_url()?>RecepcionGral/Entradas/Dependencias/EliminarDependencia/<?php echo $row->id_dependencia; ?>">
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmRegistroDependencia" action="<?php echo base_url(); ?>RecepcionGral/Entradas/Dependencias/AgregarDependencia">
        <div class="col-lg-12">
          <br>
...
<div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmModificarDependencia" action="<?php echo base_url(); ?>RecepcionGral/Entradas/Dependencias/ModificarDependencia">
        <div class="col-lg-12">
          <br>
