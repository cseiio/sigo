    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
               ...
               <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Módulo de copias turnadas a direcciones
                </li>
            </ol>
        </div>
    </div>
        ...
        <tbody style="font-size:smaller; font-weight: bold ;">
            <?php foreach ($copias_dir as $row) { 
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url()?>RecepcionGral/Entradas/CopiasDirecciones/Descargar/<?php echo $row->archivo_oficio; ?>">
