        ...
        <div class="col-lg-12">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="input-group">
                ...
                <input name="num_oficio" id="noficio" class="form-control" placeholder="Ej. OFICIO-CSEIIO-DG-0005-2018" required>
            </div>  
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            <div class="help-block with-errors"></div> 
            <span class="label label-danger">*El formato del número de oficio debe ser el siguiente: OFICIO-CSEIIO-DG-0005-2018.</span>
 ...
 -->
         ...
         <div class="form-group">
             ...
             if (count($funcionarioscseiio)) {
                echo "<option>Seleccione a un funcionario</option>";
...
<div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmEditarOficio" action="<?php echo base_url(); ?>RecepcionGral/Salidas/PanelSalidas/ModificarOficio">
        <div class="col-lg-12">
          <br>
...
<div id="fecha_termino_div_a" style="display: block;" class="form-group has-feedback">
    ...
    <div class="input-group">
       <span class="input-group-addon"></span>
       <input type="date" id="fecha" name="fecha_termino_a" class="form-control">
   </div>
   <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
   <div class="help-block with-errors"></div>  
</div>
...
?>
   ...
   <div class="form-group has-feedback">
    ...
    <div class="input-group">
        <span class="input-group-addon"></span>
        <input type="file" id="ofrespuesta_f" name="archivo" class="form-control">
    </div>
    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
    <div class="help-block with-errors"></div> 
    <span class="label label-danger">*El archivo debe estar en formato PDF</span>
...
function EditarOficio(id,num_oficio, asunto, tipo_emision,  tipo_documento, fun_emisor, cargo, remitente,cargo_remitente, dependencia_remitente, fecha_acuse, hora_acuse, codigo_archivistico, valor_doc, vigencia_doc, tipo_doc_archivistico, clasificacion_info, tieneRespuesta, observaciones)
{
