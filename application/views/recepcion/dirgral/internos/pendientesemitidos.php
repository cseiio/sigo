                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            <?php echo $this->session->userdata('nombre_direccion'); ?> <small>Oficios Pendientes</small>
                        </h2>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Módulo de oficios emitidos pendientes
                            </li>
                        </ol>
                    </div>
                </div>
                  ...
                  <table id="tabla" class="table table-bordered table-hover table-responsive">
                    <thead style="background-color:#50C1C1; color:#FFFFFF; font-size: smaller; text-aling:center;">
                        ...
                        <tbody style="font-size:smaller; font-weight: bold ;">
                                <?php foreach ($pendientesemitidos as $row) { 
                                    ?>
                               <tr>
