    ...
    <div class="modal fade" id="modalNuevo" tabindex="-1" role="dialog" aria-hidden="true" style="overflow-y: scroll;">
      <div class="modal-dialog" id="mdialTamanio">
        <div class="modal-content">
          ...
          <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmRegistroOficioDir" action="<?php echo base_url(); ?>RecepcionGral/DirGral/Interno/RecepcionInterna/agregarEntrada">
            <div class="col-lg-12">
              <br>
               <input style="visibility: hidden" name="area_trabajo" placeholder="Ej. Dir Planeación" value="DIRECCIÓN GENERAL" >
              <!-- Numero de oficio: -->
              ...
              <div class="form-group">
               ...
               <div class="form-group has-feedback">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                   <input name="emisor_h" class="form-control" placeholder="Ej. Lic. Ana Maria Robles Mijangos" required>
                </div>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div> 
              </div> 
              ...
              <div class="form-group has-feedback">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                    <input name="cargo_h" class="form-control" placeholder="Directora del Bachillerato Integral Comunitario N° 31"  required>
                </div>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div> 
              </div> 
               ...
               <div class="form-group has-feedback">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                    <input name="dependencia_h" class="form-control" placeholder="Bachillerato Integral Comunitario N° 31"  required>
                </div>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div> 
              </div> 

           <!--  <input type="hidden" name="cargo_h" value="DIRECTORA GENERAL"> -->

            <!-- <input type="hidden" name="dependencia_h" value="CSEIIO">

            <input type="hidden" name="emisor_h" value="PROFA. EMILIA GARCÍA GUZMÁN"> -->
          ...
          function enable_a() {
            ...
            <div>
              <label  class="control-label">Direcciones y Departamentos de destino</label>
            <div class="container">
...
<div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" id="mdialTamanio">
    <div class="modal-content">
      ...
      <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmEditarOficio" action="<?php echo base_url(); ?>RecepcionGral/DirGral/Interno/RecepcionInterna/ModificarOficio">
        <div class="col-lg-12">
          <br>
...
<div class="modal fade" id="modalDir" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" role="form" method="POST" name="frmTurnarDir" action="<?php echo base_url(); ?>RecepcionGral/DirGral/Interno/RecepcionInterna/TurnarCopiaDir">
        <div class="col-lg-12">
          <br>
...
<div class="modal fade" id="modalDeptos" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" role="form" method="POST" name="frmTurnarDepto" action="<?php echo base_url(); ?>RecepcionGral/DirGral/Interno/RecepcionInterna/TurnarCopiaDeptos">
        <div class="col-lg-12">
          <br>
...
function EditarOficio(id,num_oficio, asunto, tipo_recepcion,  tipo_documento, emisor, cargo,dependencia, direccion, fecha_termino, prioridad, is_informativo, asignaciones, num_oficio_id, codigo_archivistico, valor_doc, vigencia_doc, tipo_doc_archivistico, clasificacion_info, tieneRespuesta, observaciones)
{
 ...
 if (is_informativo == 'no') 
 {
  ...
  document.frmEditarOficio.cargo_h.value = cargo;
  document.frmEditarOficio.dependencia_h.value = dependencia;
...
// console.log(cadena);
  ...
  //Solicitud ajax
   ...
   //document.frmEditarOficio.ReqRespuesta_a.value = tieneRespuesta;
...
//Modal para mostrar los números de oficio para direcciones de área
