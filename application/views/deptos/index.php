                 ...
                 <li class="active">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li >
                            <a href="<?php echo base_url(); ?>Departamentos/Interno/BuzonInterno"><i class="fa fa-arrow-down"></i> Buzón de oficios internos</a>
                        </li>

                        <li>
                            <a href="<?php echo base_url(); ?>Departamentos/Interno/RecepcionInterna"><i class="fa fa-arrow-up"></i> Oficios Emitidos</a>
                        </li>
    ...
    <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            ...
                            ?> <small>Paneles Estadísticos</small>
                        </h2>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    <h3 style="text-align: center;">Proceso Externo</h3>
                    <br>
