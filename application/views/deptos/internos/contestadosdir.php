...
<!-- /#wrapper -->
    <div class="modal fade" id="modalActualizarArchivo" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmActualizarArchivos" action="<?php echo base_url(); ?>Departamentos/Interno/ContestadosInterno/ModificarArchivos">
            <div class="col-lg-12">
