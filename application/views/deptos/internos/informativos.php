                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <h2 class="page-header">
                        ...
                        ?> <small>Oficios Informativos</small>
                      </h2>
                      <ol class="breadcrumb">
                        <li class="active">
                          <i class="fa fa-dashboard"></i> Módulo de oficios informativos recepcionados
                        </li>
                      </ol>
                    </div>
                  </div>
                        ...
                        <tbody style="font-size:smaller; font-weight: bold ;">
                          <?php foreach ($informativos as $row) { 
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url()?>Departamentos/Interno/Informativos/Descargar/<?php echo $row->archivo_oficio; ?>">
           ...
           <div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmEditarOficio" action="<?php echo base_url(); ?>Departamentos/Interno/RecepcionInterna/ModificarOficioInterno">
                  <div class="col-lg-12">
                    <br>
