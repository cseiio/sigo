                ...
                <div class="row">
                    <div class="col-lg-12">
                         <h2 class="page-header">
                            ...
                            ?> <small>Oficios Internos</small>
                        </h2>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Oficios Internos
                            </li>
                        </ol>
                    </div>
                </div>
              ...
              <table id="tabla" class="table table-bordered table-hover table-responsive">
                ...
                <tbody style="font-size:smaller; font-weight: bold ;">
                    ...
                    <?php 
                        ...
                        if ($this->Modelo_departamentos->comprobarSielAreaYaRespondio($this->session->userdata('id_area'),$row->num_oficio)) { ?>
                     <td>
