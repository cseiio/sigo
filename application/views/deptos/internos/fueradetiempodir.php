...
<!-- /#page-wrapper -->
    ...
    <!-- /#wrapper -->
      ...
      <div class="modal-dialog">
        ...
        <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmActualizarArchivos" action="<?php echo base_url(); ?>Departamentos/Interno/FueraDeTiempoInterno/ModificarArchivos">
            <div class="col-lg-12">
