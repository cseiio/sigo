          ...
          <table id="tabla" class="table table-bordered table-hover table-responsive">
            <thead style="background-color:#50C1C1; color:#FFFFFF; font-size: smaller; text-aling:center;">
              <tr>
                ...
                <th>Dependencia</th>
                <th>Cargo</th>
                <th>Fecha y Hora de Emisión Física</th>
            ...
            <tbody style="font-size:smaller; font-weight: bold ;">
              <?php foreach ($fueratiempo as $row) { 
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url()?>RecepcionGral/Salidas/Contestados/Descargar/<?php echo $row->archivo; ?>">
               ...
               <td>
                ...
                if ($row->tipo_dias == 0) 
                {
                 ...
                 else
                 {
                  ...
                  <td>
                    <a href="<?php echo base_url()?>RecepcionGral/Salidas/Contestados/DescargarRespuesta/<?php echo $row->acuse_respuesta; ?>">
                 ...
                 <!-- ANEXOS -->
                 <td>
                  <a href="<?php echo base_url()?>RecepcionGral/Salidas/Contestados/DescargarAnexos/<?php echo $row->anexos; ?>">
                   <img src="<?php echo base_url(); ?>assets/img/anexos.png" alt="Descargar">
                 </a>
               </td>

                <td><?php echo $row->fecha_subida.' '.$row->hora_subida; ?></td>     
             </tr>
             <?php } ?>
           </tbody>
         </table>
