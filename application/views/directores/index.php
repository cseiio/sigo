...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="container-fluid">
            ...
            <li>
                <a href="<?php echo base_url(); ?>Direcciones/Salidas/PanelSalidas"><i class="fa fa-arrow-up""></i> Oficios de Salida</a>
            </li>
     ...
     <!-- manual_de_operacion_sigo_planteles.pdf -->
        </ul>
    </div>
    <!-- /.navbar-collapse -->
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="<?php echo base_url(); ?>Direcciones/Salidas/PanelSalidas">
                            <div class="panel-footer">
                                <span class="pull-left">Ver mas Información</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
