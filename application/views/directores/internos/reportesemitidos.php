                ...
                <ul style="font-size: small;" class="nav navbar-nav">
                    <li>
                     ...
                     <li>
                      ...
                      <li>
                        <a href="<?php echo base_url(); ?>Direcciones/Interno/FueraDeTiempoInterno"><i class="fa fa-bell-slash"></i> Oficios Emitidos Contestados Fuera de Tiempo</a>
                      </li>

                      <li>
                        <a href="<?php echo base_url(); ?>Direcciones/Interno/NoContestadosInterno"><i class="fa  fa-times-circle"></i>Oficios Emitidos No Contestados</a>
                      </li>

                      <li>
                        <a href="<?php echo base_url(); ?>Direcciones/Interno/Informativos"><i class="fa  fa-info-circle"></i>Oficios Emitidos Informativos</a>
                      </li>
          ...
          <div id="menu1" class="tab-pane fade">
            ...
            <div class="tab-content">
              ...
              <div id="generales1" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Interno/ReportesEmitidos/reporteEmitidosDireccionesInt">
              ...
              <div id="generales2" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Interno/ReportesEmitidos/reportePendientesDireccionesInt">
              ...
              <div id="generales3" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Interno/ReportesEmitidos/reporteContestadosDireccionesInt">
              ...
              <div id="generales4" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Interno/ReportesEmitidos/reporteContestadoFueraDeTiempoDir">
              ...
              <div id="generales5" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Interno/ReportesEmitidos/reporteNoContestadosDireccionesInt">
