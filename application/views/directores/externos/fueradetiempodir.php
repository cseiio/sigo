                  ...
                  <table id="tabla" class="table table-bordered table-hover table-responsive">
                    <thead style="background-color:#50C1C1; color:#FFFFFF; font-size: smaller; text-aling:center;">
                         <tr>
                            ...
                            <th>Fecha Hora de Subida del Oficio al Sistema</th>
    ...
    <!-- /#wrapper -->
     ...
     <div class="modal fade" id="modalActualizarArchivo" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmActualizarArchivos" action="<?php echo base_url(); ?>Direcciones/Externos/ContestadosFueraTiempoDir/ModificarArchivos">
            <div class="col-lg-12">
