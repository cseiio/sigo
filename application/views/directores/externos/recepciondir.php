       ...
       <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">
                <?php echo $this->session->userdata('nombre_direccion'); ?> <small>Oficios Externos</small>
            </h2>
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Recepción de Oficios Externos
                </li>
            </ol>
        </div>
    </div>
...
<?php if($row->flag_deptos == 1) { ?>
    <td>
        <button type="button" onclick="mostrarModalRespuestas('<?php echo $row->id_recepcion; ?>','<?php echo $row->num_oficio; ?>','<?php echo $row->asunto; ?>','<?php echo $row->emisor; ?>');" class="form-control btn btn-success btn-sm" disabled>
    ...
    <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmRespuesta" action="<?php echo base_url(); ?>Direcciones/Externos/RecepcionDir/agregarRespuesta">
        ...
        <div class="form-group has-feedback">
            ...
            <div class="input-group">
                ...
                <input name="numoficio_salida" id="noficio" class="form-control" placeholder="Ej. OFICIO-CSEIIO-DG-0001-2017" required>
            </div>
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            <div class="help-block with-errors"></div> 
            <span class="label label-danger">*El formato del número de oficio debe ser el siguiente: OFICIO-CSEIIO-DG-0001-2017.</span>
...
<div class="form-group has-feedback">
    <label for="fecha_res_fisica" class="control-label">Fecha de Respuesta Física</label>
    <div class="input-group">
     <span class="input-group-addon"></span>
     <input type="date" id="fecha_res_fisica" name="fecha_res_fisica" class="form-control" required>
 </div>
 <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
 <div class="help-block with-errors"></div>  
</div>
...
<div class="form-group has-feedback">
    <label for="hora_res_fisica" class="control-label">Hora de Respuesta Física</label>
    <div class="input-group">
     <span class="input-group-addon"></span>
     <input type="time" id="hora_res_fisica" name="hora_res_fisica"  class="form-control"  value="<?php echo date("H:i:s") ?>"/ required>
 </div>
 <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
 <div class="help-block with-errors"></div>  
</div>
        ...
        <div class="col-lg-12">
          ...
          <table id="tabla" class="table table-bordered table-hover table-responsive">
            ...
            <tbody style="font-size:smaller; font-weight: bold ;">
                ...
                $query = $this->Modelo_direccion->getAllsByNumOficioSalida();
...
function mostrarModaldeAsignacion(idrecepcion, num_oficio, asunto, receptor)
{
    ...
    var url = "<?php echo base_url(); ?>Direcciones/Externos/RecepcionDir/obtenerDeptosAsignados/"+idrecepcion+"";
